    ...
    <form onSubmit={handleSubmit} className="space-y-12 max-w-3xl">
      ...
      <section>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          <Field label="Data de conversão (aceitou a Jesus)" n="e.">
            <Input
              type="date"
          ...
          <div className="sm:col-span-2 grid sm:grid-cols-2 gap-6">
            ...
            <div className="flex items-center gap-3 pt-2">
              <Checkbox
                id="fez_curso_membresia"
                checked={!!form.fez_curso_membresia}
                onCheckedChange={(v) => set("fez_curso_membresia", !!v)}
              />
              <label htmlFor="fez_curso_membresia" className="text-sm font-serif">
                Fez o Curso de Membresia (Nazareno)
              </label>
            </div>
          </div>
        </div>
