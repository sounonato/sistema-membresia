              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-border">
                    <TableHead className="text-[10px] uppercase tracking-widest text-muted-foreground w-16">
                      Cap.
                    </TableHead>
                ...
                <TableBody>
                  {data.map((m, i) => (
                    <TableRow key={m.id} className="border-border hover:bg-muted">
                      ...
                      <TableCell className="text-sm italic text-muted-foreground max-w-md truncate">
                        {m.descricao}
                      </TableCell>
                      ...
                      {editor && (
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-1">
                            <Button size="icon" variant="ghost" onClick={() => abrirEdit(m)}>
        ...
        <DialogContent className="rounded-2xl">
          <DialogHeader>
            <DialogTitle className="font-serif text-primary">
              {edit ? "Editar Módulo" : "Novo Módulo"}
            </DialogTitle>
          </DialogHeader>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) => setForm({ ...form, total_aulas: Number(e.target.value) })}
                />
              </div>
              <div className="space-y-1.5">
                <Label>Ordem</Label>
