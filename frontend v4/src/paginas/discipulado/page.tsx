      ...
      <div className="bg-card border border-border">
        <div className="p-4 sm:p-6">
          {isLoading ? (
            ...
            <p className="py-10 text-center text-sm text-muted-foreground italic font-serif">
              Nenhum grupo cadastrado — o primeiro círculo ainda espera por uma cadeira posta.
            </p>
          ) : (
                    ...
                    <TableRow key={g.id} className="border-border hover:bg-muted">
                      ...
                      <TableCell>
                        <Link
                          to="/discipulado/$id"
                          params={{ id: g.id }}
                          className="font-serif text-lg text-foreground hover:text-primary underline-offset-4 hover:underline"
                        >
                          {g.nome}
                        </Link>
                      </TableCell>
                      <TableCell className="text-sm text-foreground">
                        {g.discipulador_nome ?? g.discipulador ?? "—"}
                      </TableCell>
                      <TableCell className="text-sm italic text-muted-foreground">
                        {g.modulo_nome ?? g.modulo ?? "—"}
                      </TableCell>
                      <TableCell className="text-right font-serif text-lg tabular-nums text-foreground">
                        {g.qtd_membros ?? g.membros?.length ?? 0}
                      </TableCell>
                      <TableCell>
                        <span
                          className={
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={(v) => setForm({ ...form, discipulador_id: v })}
              >
                <SelectTrigger>
