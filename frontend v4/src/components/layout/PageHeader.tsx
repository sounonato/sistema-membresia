    ...
    <header className="border-b border-border/70 pb-6 mb-8">
      <div className="flex items-end justify-between gap-6 flex-wrap">
        <div className="max-w-3xl">
          <p className="flex items-center gap-3 text-[10px] uppercase tracking-[0.35em] text-muted-foreground">
          ...
          <h1 className="mt-3 font-serif text-4xl md:text-5xl leading-[1.05] text-foreground tracking-tight">
            {title}
          </h1>
          {lede && (
            <p className="mt-3 font-[Instrument_Serif,serif] italic text-lg text-muted-foreground leading-snug">
              {lede}
            </p>
          )}
        </div>
